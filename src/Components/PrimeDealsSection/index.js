...
const PrimeDealsSection = () => {
    ...
    const renderPrimeDealsFailureView = () => {
        return (
            <img src="https://assets.ccbp.in/frontend/react-js/exclusive-deals-banner-img.png" alt="" className="register-prime-image" />
        )
    ...
    const renderLoadingView = () => {
        return (
            <div className="products-loader-container">
                <ThreeDots height='50px' width='50px' radius='9' color="#0b69ff" />
            </div>
        )
    }
